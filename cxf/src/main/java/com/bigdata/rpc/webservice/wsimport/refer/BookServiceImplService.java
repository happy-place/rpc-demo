 ...
 * 
 */
@WebServiceClient(name = "BookServiceImplService", targetNamespace = "http://service.original.webservice.bigdata.com/", wsdlLocation = "http://127.0.0.1:8080/book/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICEIMPLSERVICE_QNAME = new QName("http://service.original.webservice.bigdata.com/", "BookServiceImplService");
    ...
    public BookServiceImpl getBookServiceImplPort() {
        return super.getPort(new QName("http://service.original.webservice.bigdata.com/", "BookServiceImplPort"), BookServiceImpl.class);
    }
    ...
    public BookServiceImpl getBookServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.original.webservice.bigdata.com/", "BookServiceImplPort"), BookServiceImpl.class, features);
    }
